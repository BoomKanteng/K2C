...
<?php include('sidebar.php'); ?>
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid"> 
        <div class="row">
          ...
          <section class="col-lg-6 connectedSortable">
            ...
            FROM workout
            LEFT JOIN user
            ON workout.uID = user.uID
            
            WHERE wDate='".$DateYesterday."'
            GROUP BY uName
            ORDER BY wKcal DESC LIMIT 15";
    ...
    <tr height="30 px">
      ...
      <td width="25%">Total kcal</td>
    </tr>
  <?php
    while($objResultAllworkout = mysqli_fetch_array($objQueryAllworkout)) {
  ?>
      <tr>     
         <?php if($objResultAllworkout['wKcal'] != 0){ ?>
        <td width="7%"><?php echo $Meal=$Meal+1,"&nbsp;&nbsp;";?></td>
        <td><?php echo $objResultAllworkout['uName']?></td>
        <td width="10%"><?php  echo $objResultAllworkout['wKcal']; ?></td>
